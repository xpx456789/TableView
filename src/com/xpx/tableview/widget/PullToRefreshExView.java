...
public class PullToRefreshExView extends LinearLayout {
	...
	public PullToRefreshExView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshExView(Context context) {
		super(context);
		init();
	}
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(Resource.getIdByName(this.getContext(), "layout", "refresh_header"), this, false);

		mHeaderImageView = (ImageView) mHeaderView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_refresh_image"));
		mHeaderTextView = (TextView) mHeaderView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_refresh_text"));
		mHeaderUpdateTextView = (TextView) mHeaderView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_refresh_updated_at"));
		mHeaderProgressBar = (ProgressBar) mHeaderView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_refresh_progress"));
		// header layout
		measureView(mHeaderView);
		mHeaderViewHeight = mHeaderView.getMeasuredHeight();
		LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, mHeaderViewHeight);
		// 璁剧疆topMargin鐨勫�间负璐熺殑header View楂樺害,鍗冲皢鍏堕殣钘忓湪鏈�涓婃柟
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(Resource.getIdByName(this.getContext(), "layout", "refresh_footer"), this, false);
		mFooterImageView = (ImageView) mFooterView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_load_image"));
		mFooterTextView = (TextView) mFooterView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_load_text"));
		mFooterProgressBar = (ProgressBar) mFooterView.findViewById(Resource.getIdByName(this.getContext(), "id", "pull_to_load_progress"));
		// footer layout
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			int deltaY = y - mLastMotionY;
			//if(deltaY > InterskyApplication.mAppScreenDenineModel.mPullScollY || deltaY < -InterskyApplication.mAppScreenDenineModel.mPullScollY)
			{
	...
	private boolean isRefreshViewScroll(int deltaY) {
		...
		if (mAdapterView != null) {
			...
			if (deltaY > 0) {
				...
				if (mAdapterView.getFirstVisiblePosition() == 0 && Math.abs(top - padding) <= 11) {// 杩欓噷涔嬪墠鐢�3鍙互鍒ゆ柇,浣嗙幇鍦ㄤ笉琛�,杩樻病鎵惧埌鍘熷洜
					mPullState = PULL_DOWN_STATE;
					return true;
				}
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			...
			mHeaderImageView.startAnimation(mFlipAnimation);
			// mHeaderImageView.
			mHeaderTextView.setText(Resource.getIdByName(this.getContext(), "string", "pull_to_refresh_pull_label"));
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterState != RELEASE_TO_REFRESH) {
			mFooterTextView.setText(Resource.getIdByName(this.getContext(), "string", "pull_to_refresh_footer_release_label"));
			...
			mFooterImageView.clearAnimation();
			mFooterImageView.startAnimation(mFlipAnimation);
			mFooterTextView.setText(Resource.getIdByName(this.getContext(), "string", "pull_to_refresh_footer_pull_label"));
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setText(Resource.getIdByName(this.getContext(), "string", "pull_to_refresh_footer_refreshing_label"));
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(Resource.getIdByName(this.getContext(), "drawable", "ic_pulltorefresh_arrow"));
		mHeaderTextView.setText(Resource.getIdByName(this.getContext(), "string", "pull_to_refresh_pull_label"));
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(Resource.getIdByName(this.getContext(), "drawable", "ic_pulltorefresh_arrow_up"));
		mFooterTextView.setText(Resource.getIdByName(this.getContext(), "string", "pull_to_refresh_footer_pull_label"));
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullToRefreshExView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(PullToRefreshExView view);
	}
